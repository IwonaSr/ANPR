package com.example.ejwon.anpr.neural;
...
public class KohonenNetwork extends Network implements Serializable{
    private static final String TAG = "KohonenNet.java";
...
// just in case it gets too small
     ...
     synth[0] = 0.0 ;
       Log.e(TAG, "normfac[0]: " + normfac[0]);
       Log.e(TAG, "synth[0]: " + synth[0]);
